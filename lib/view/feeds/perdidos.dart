...
class AnimaisPerdidos extends StatefulWidget {
  @override
  _AnimaisPerdidosState createState() => _AnimaisPerdidosState();
}

class _AnimaisPerdidosState extends State<AnimaisPerdidos> {
  PerdidoDAO an = new PerdidoDAO();
